...
async def db_init(Url):
    ...
    queries = {
        ...
        'infractions': "CREATE TABLE infractions(id SERIAL PRIMARY KEY, guildid bigint, memberid bigint, time timestamp, reason text, FOREIGN KEY (guildid) REFERENCES guilds(id) ON DELETE CASCADE)"
    }
    count = 0
